...
| Source | Decision | Active coverage or reason |
| --- | --- | --- |
| *Biological Data Science with R* | Keep six active lessons and restore complete Chapters 9 and 12 | Chapter 8 is represented through 8.7 across the NHANES lessons, including all three Welch questions and restored Understanding panels. Chapter 9 includes sections 9.1-9.3.2 and Exercises 1-13 over exact lung, colon, and RTCGA data. Chapter 12 includes all fourteen exercises over exact airway data, an independently regenerated historical DESeq2 oracle, and BioLang-generated analytical plots. Predictive remains withheld for substituted models; ggtree remains withheld because the source teaching tree and bonus data are explicitly made-up/random. |
