...
The lesson follows the public sequence of topics through section 9.3.1.2 so a
learner can compare workflows. Its prose, BioLang programs, validation code,
and SVG figures were independently written and generated. Upstream prose, R
code, tables, and figure files are not copied or relicensed. This work is not
an official BDSR publication and does not imply endorsement.
