...
- Earlier *Biological Data Science with R* drafts remain under
  `archive/p2-non-fidelity-bdsr` for audit. Their validated complete Chapter 9
  material has now been restored into the active `bdsr-lung-survival` lesson,
  while Chapter 8 is covered across the active NHANES lessons through section
  8.7. Predictive, RNA-seq, and ggtree drafts remain withheld because their
  substituted algorithms, precomputed outputs, or random data do not meet the
  current one-to-one/no-synthetic-data requirement.
